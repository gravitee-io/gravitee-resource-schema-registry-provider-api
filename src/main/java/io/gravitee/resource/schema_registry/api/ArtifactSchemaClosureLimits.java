 ...
 * Timers (defaults):
 * <ul>
 *   <li>{@code perArtifactFetchTimeoutMs} — max wait for a single /content or /references call (10s)</li>
 *   <li>{@code totalClosureFetchTimeoutMs} — max wall time for the whole root+references walk (60s)</li>
 * </ul>
 */
public final class ArtifactSchemaClosureLimits {
    ...
    private final long perArtifactFetchTimeoutMs;
    ...
    public ArtifactSchemaClosureLimits(
        ...
        int maxImportDepth,
        long perArtifactFetchTimeoutMs,
        ...
        this.perArtifactFetchTimeoutMs = perArtifactFetchTimeoutMs;
        this.totalClosureFetchTimeoutMs = totalClosureFetchTimeoutMs;
    }

    public static ArtifactSchemaClosureLimits defaults() {
        return new ArtifactSchemaClosureLimits(50, 10L * 1024 * 1024, 10, 10_000L, 60_000L);
    }
    ...
    public long perArtifactFetchTimeoutMs() {
        return perArtifactFetchTimeoutMs;
    }
